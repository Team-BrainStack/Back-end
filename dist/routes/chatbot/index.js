...
const generateEmbeedings_1 = require("../../embeddings/generateEmbeedings");
const client_1 = require("../../pinecone/client");
const mistralchat_1 = require("./mistralchat");
...
app.get("/chatbot", async (c) => {
    ...
    try {
        ...
        const queryEmbedding = await (0, generateEmbeedings_1.generateEmbedding)(query);
        // Step 2: Query Pinecone for similar vectors
        const index = client_1.pinecone.Index(process.env.PINECONE_INDEX);
...
"${query}"
`;
        const response = await (0, mistralchat_1.mistralChat)([
            {
                role: "user",
                content: prompt,
            },
